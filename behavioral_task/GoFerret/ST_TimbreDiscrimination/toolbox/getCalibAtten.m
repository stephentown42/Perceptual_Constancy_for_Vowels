...
% Values checked 26 January 2015 - all within +/- 0.5 dB
...
calib.id    = [460 1105; 
             ...
             % 149  200  263  330  459  Whispered   
calib.right = [63.1 63.5 63.0 63.2 61.1 44.0;           % 460 1105
               65.5 66.1 66.5 64.3 66.9 55.0;           % 730 2058
...
calib.left = [65.7 65.1 61.5 64.2 64.7 55.6;
              66.2 66.3 66.6 65.5 68.0 61.0;
