        ...
        if (leftLick == 0) && (rightLick==0)
            ...
            if rightLick > 0,
                ...
                if gf.side == 1 || gf.side == -1,
                    ...
                    comment    = 'Incorrect response to "right" - no reward';
                    
                    % Correction trial following error
                    % Go straight to waiting, do not prepare another stimulus.
                    % Use the same stimulus in a correction trial until the correct response is made.
            ...
            elseif leftLick > 0
                ...
                if gf.side == 0 || gf.side == -1,
                    ...
                    comment    = 'Incorrect response to "left" - no reward';
